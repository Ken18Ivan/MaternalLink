...
import { FolderPlus, Trash2, Search, Eye, X, Send, Calendar, MessageSquare, Hash, Clock, CheckCircle, Download } from "lucide-react";
import axios from "axios";
import { toast } from "react-hot-toast";

// --- FIX 1: Import jsPDF and autoTable separately ---
...
const PatientsPage = () => {
  ...
  const generatePDF = () => {
    try {
        ...
        doc.text(`Pregnancy Stage: ${selectedPatient.pregnancyWeeks} Weeks`, 14, 66);
        ...
        // 4. Footer
        // We use (doc as any) or just try/catch to access lastAutoTable if needed, 
        // but typically autoTable attaches state to the doc object.
                ...
                <tr key={patient._id} className="hover:bg-gray-50/80 border-b border-gray-100 last:border-none">
                  ...
                  <td className="py-6">
                    <div className="badge badge-lg bg-pink-50 text-pink-600 border-pink-100 font-black">
                      {patient.pregnancyWeeks ? `${patient.pregnancyWeeks} Weeks` : "N/A"}
                    </div>
                  </td>
                  <td className="py-6">
